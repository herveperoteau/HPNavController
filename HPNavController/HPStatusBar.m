...
+ (HPStatusBar*)sharedView {
    ...
    dispatch_once(&once, ^ { sharedView = [[HPStatusBar alloc] initWithFrame:[[UIScreen mainScreen] bounds]]; });
    return sharedView;
}
...
+ (void)showWithStatus:(NSString*)status withActivityIndicator:(BOOL)withActivityIndicator {
    ...
    [[HPStatusBar sharedView] showWithStatus:status
                                   ...
                                   textColor:[UIColor colorWithRed:191.0/255.0 green:191.0/255.0 blue:191.0/255.0 alpha:1.0]
