...
@implementation HPUIGradientButton
...
#define HPUIGradientButtonDefaultCorderRadius	10.0
#define HPUIGradientButtonDefaultBorderWidth	2.0
...
- (void)updateAccordingToStyle
{
	switch (_style)
	{
		case HPUIGradientButtonStyleBlackOpaque:
		{
		...
		case HPUIGradientButtonStyleBlackTranslucent:
		{
		...
		case HPUIGradientButtonStyleDefault:
		{
...
- (id)initWithFrame:(CGRect)frame style:(HPUIGradientButtonStyle)style cornerRadius:(CGFloat)cornerRadius radiusStyle:(HPUIGradientButtonRadiusStyle) radiusStyle borderWidth:(CGFloat)borderWidth andText:(NSString *)text {
    ...
    if (self)
	{
        ...
        _styleRadius = radiusStyle; // les 4 coins arrondis
...
- (id)initWithFrame:(CGRect)frame style:(HPUIGradientButtonStyle)style
{
	return [self initWithFrame:frame
                         style:style
                  cornerRadius:HPUIGradientButtonDefaultCorderRadius
                   borderWidth:HPUIGradientButtonDefaultBorderWidth
                       andText:nil];
}
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
	...
	if (self)
	{
		_cornerRadius = HPUIGradientButtonDefaultCorderRadius;
        _styleRadius = HPUIGradientButtonRadiusStyleAll;
		_borderWidth = HPUIGradientButtonDefaultBorderWidth;
		
		[self performDefaultInit];
		
		self.style = HPUIGradientButtonStyleDefault;
	}
	return self;
}
...
- (void)setStyle:(HPUIGradientButtonStyle)style
{
	if (style != _style)
	{
		_style = style;
...
- (void)drawRect:(CGRect)rect
{
    ...
    if (_styleRadius == HPUIGradientButtonRadiusStyleLeft) {
        
        path = [UIBezierPath bezierPathWithRoundedRect:self.bounds
                                     byRoundingCorners:UIRectCornerTopLeft|UIRectCornerBottomLeft
                                           cornerRadii:CGSizeMake(self.cornerRadius, self.cornerRadius)];
    }
    else if (_styleRadius == HPUIGradientButtonRadiusStyleRight) {
	...
	if (leftImage)
	{
        if (text==nil || text.length==0) {
            ...
            leftAccessoryRect.origin.x = (CGRectGetWidth(self.bounds) - CGRectGetWidth(leftAccessoryRect)) / 2;;
        }
        else {
